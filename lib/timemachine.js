 ...
 * and a thin fork wrapper delegating to the official sessions.fork (a cold
 * source surfaces the store's own "session not found" error; the UI disables
 * fork for cold sessions and shows a friendlier banner up front).
 *
